        ...
        <div class="pickupContents">
            ...
            <div class="flex">
                <div class="pickupCard">
                    <figure>
                        <a href="<?php the_permalink(148); ?>"><img src="<?php echo get_template_directory_uri(); ?>/./img/pickupImg_1.jpg" alt=""></a>
                    </figure>
                ...
                <div class="pickupCard">
                    <figure>
                        <a href="<?php the_permalink(123); ?>"><img src="<?php echo get_template_directory_uri(); ?>/./img/pickupImg_2.jpg" alt=""></a>
                    </figure>
                    <div class="dateContent">
                ...
                <div class="pickupCard">
                    <figure>
                        <a href="<?php the_permalink(129); ?>"><img src="<?php echo get_template_directory_uri(); ?>/./img/pickupImg_3.jpg" alt=""></a>
                    </figure>
                    <div class="dateContent">
        ...
        <div class="processContents">
            ...
            <div class="processContent">
                <div class="flex">
                    <figure class="processImg">
                        <img src="<?php echo get_template_directory_uri(); ?>/./img/processImg_1.jpg" alt="">
                    </figure>
            ...
            <div class="processContent">
                <div class="flex">
                    ...
                    <figure class="processImg">
                        <img src="<?php echo get_template_directory_uri(); ?>/./img/processImg_2.jpg" alt="">
                    </figure>
                </div>
            ...
            <div class="processContent">
                <div class="flex">
                    <figure class="processImg">
                        <img src="<?php echo get_template_directory_uri(); ?>/./img/processImg_3.jpg" alt="">
                    </figure>
                    <div class="processText">
                        <h3>コーディング・CMS実装</h3>
            ...
            <div class="processContent">
                <div class="flex">
                    ...
                    <figure class="processImg">
                        <img src="<?php echo get_template_directory_uri(); ?>/./img/processImg_4.jpg" alt="">
                    </figure>
                </div>
